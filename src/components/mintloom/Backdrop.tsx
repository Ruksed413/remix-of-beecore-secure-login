  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <svg className="absolute inset-0 h-full w-full" viewBox="0 0 1440 960" preserveAspectRatio="xMidYMid slice">
        <g className="animate-drift-slow origin-center">
          <path
        ...
        <g className="animate-drift-slow-reverse origin-center">
          <path
        ...
        <g fill="var(--muted-foreground)" fillOpacity="0.28" className="animate-pulse-soft">
        ...
        <g fill="var(--gold)" fillOpacity="0.35" className="animate-pulse-soft" style={{ animationDelay: "3s" }}>
